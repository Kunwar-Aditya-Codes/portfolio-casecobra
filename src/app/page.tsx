        ...
        <MaxWidthWrapper className='pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg:pt-24 xl:pt-32 lg:pb-52'>
          <div className='col-span-2 px-6 lg:px-0 lg:pt-0'>
            <div className='relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start'>
              <div className='absolute w-[7.5rem] left-0 -top-20 hidden lg:block'>
                <img src={'/phone-1.png'} className='w-full' />
              </div>
              ...
              <p className='mt-8 text-lg lg:pr-10 max-w-prose text-center lg:text-left text-balance md:text-wrap'>
                ...
                StyleCase allows you to protect your memories, not just your
                phone case.
              </p>
              <ul className='mt-8 space-y-2 font-medium text-left  flex flex-col items-center sm:items-start'>
                <div className='space-y-2'>
                  ...
                  <li className='flex gap-1.5 items-center text-left'>
                    <Check className='size-5 shrink-0 text-purple-600' />5 year
                    print guarantee
                  </li>
                  <li className='flex gap-1.5 items-center text-left'>
                    <Check className='size-5 shrink-0 text-purple-600' />
              ...
              <div className='mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5'>
                ...
                <div className='flex flex-col justify-between items-center sm:items-start'>
                  <div className='flex gap-0.5'>
                    <Star className='size-4 text-purple-600 fill-purple-600 ' />
                    <Star className='size-4 text-purple-600 fill-purple-600 ' />
                    <Star className='size-4 text-purple-600 fill-purple-600 ' />
                    <Star className='size-4 text-purple-600 fill-purple-600 ' />
                    <Star className='size-4 text-purple-600 fill-purple-600 ' />
        ...
        <MaxWidthWrapper className='flex flex-col items-center gap-16 sm:gap-32'>
          <div className='flex flex-col lg:flex-row items-center gap-4 sm:gap-6'>
            ...
            <img
              src='/phone-2.png'
              alt=''
              className='w-12 order-0 lg:order-2'
            />
          </div>
          ...
          <div className='mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16'>
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  &apos;The case feels durable and got compliment on design. Had
                  the case for two and half months now and{' '}
              ...
              <div className='flex gap-4 mt-2'>
                ...
                <div className='flex flex-col'>
                  ...
                  <div className='flex gap-1.5 items-center text-zinc-600'>
                    <Check className='size-4 stroke-[3px] text-purple-600' />
            ...
            <div className='flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20'>
              ...
              <div className='text-lg leading-8'>
                <p>
                  &apos;I usually keep my phone with keys in my pocket which
                  caused some scratches on my phone but this one barely
                  scratched the corner,{' '}
                  <span className='p-0.5 bg-slate-800 text-white'>
      ...
      <section>
        <MaxWidthWrapper className='py-24'>
          ...
          <ul className='mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit'>
            ...
            <li className='w-fit'>
              <Check className='size-5 text-purple-600 inline mr-1.5' />5 year
              print warranty
            </li>
